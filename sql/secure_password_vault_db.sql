...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2026 at 03:57 PM
...
--
-- Database: `secure_password_vault_db`
--
...
--
ALTER TABLE `password_records`
  ADD CONSTRAINT `fk_password_records_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
